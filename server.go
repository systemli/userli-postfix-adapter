...
// TODO: Postfix only opens one socket usually - is 50 MaxConcurrentConnections sensible?
const (
	MaxConcurrentConnections = 500               // Limit concurrent connections
	ConnectionTimeout        = 101 * time.Second // Connection timeout - Postfix will close an active connection after 100s
	KeepAliveTimeout         = 101 * time.Second // TCP Keep-Alive timeout
